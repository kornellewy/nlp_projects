# sources :
https://github.com/stitionai/devika/tree/main/docs/architecture
https://github.com/stitionai/devika/blob/main/docs/architecture/ARCHITECTURE.md
https://github.com/stitionai/devika/blob/main/docs/architecture/UNDER_THE_HOOD.md

### I just want to clone devica in langchain to train nlp:
...
Devika's system architecture consists of the following key components:
    ...
    Code Writing Module: Generates code based on the plan, research findings, 
    and user requirements. Supports multiple programming languages.
